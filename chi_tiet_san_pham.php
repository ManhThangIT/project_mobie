...
<body style="">
	...
	<header class="header">
		<div class="topbar">
			...
			// _____________Chuyển form đăng ký đăng nhập_________
					...
					while($row = mysqli_fetch_array($result)){
						...
						<div class="container">
									...
									<div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
										<div class="rows">
												...
												<div class="row">
													...
													<div class="col_large_default large-image">
														<a href="" class="large_image_url checkurl" data-rel="prettyPhoto[product-gallery]">
															...
															<div style="height:351px;width:351px;" class="zoomWrapper">
																<div style="height:351px;width:351px;" class="zoomWrapper">

																	<img id="img_01" class="img-responsive" src="../khachhang/dashboard/san_phamx/<?php echo $row['anh']?>" data-zoom-image="" style="position: absolute;">
													...
													<div class="aaa">
														<div id="gallery_02" class="owl-carousel owl-theme thumbnail-product thumb_product_details not-dqowl owl-loaded owl-drag" data-loop="false" data-lg-items="3" data-md-items="3" data-sm-items="3" data-xs-items="3" data-xxs-items="3">
															...
															<div class="owl-stage-outer owl-height" style="height: 75px;">
											...
											<div class="col-xs-12 col-sm-6 col-md-7 col-lg-7 details-pro">
												<h1 class="title-product"><?php echo "Tên sản phẩm:  ".$row['ten_san_pham'] ?></h1>
												<div class="group-status">
								<!-- <span class="first_status">Thương hiệu: <span class="status_name">Jelly</span></span>
							...
							<div class="price-box" itemscope="" itemtype="http://schema.org/Offer">
								...
								<div class="special-price"><span class="price product-price" itemprop="price"><?php 
								$num = $row['gia'];
								$dinh_dang = number_format($num, 0);
								echo "Giá: ".$dinh_dang." ₫"; ?></span> 
						...
						<div class="form-product col-sm-12">
								...
								<div class="form-group form_button_details margin-top-10">
									<div class="form_product_content ">
										...
										<div class="button_actions">
											<input class="hidden" type="hidden" name="variantId" value="15526574">


											<a href="">
												<button type="submit" class="btn btn-lg  btn-cart button_cart_buy_enable add_to_cart btn_buy" title="Cho vào giỏ hàng" onclick="giohang()">

													<span class="btn-image">
														<img src="//bizweb.dktcdn.net/100/289/371/themes/634361/assets/shopping_cart.png?1524126221691" alt="shopping-cart">
													</span>
												...
												<script>
													function giohang(){
														window.location.assign('them_vao_gio_hang.php?ma_san_pham=<?php echo $row['ma_san_pham'] ?>');
													}
												</script>
										...
										<div class="iwi">
											...
											<a title="Bỏ thích" class=" iWishAdded iwishAddWrapper iWishHidden" href="javascript:;" data-customer-id="0" data-product="9721688" data-variant="15526574"><i class="fa fa-heart"></i></a>
										</div>
							...
							<div class="contacts">
								<span class="block_phone">
									<span>
										<span class="text">Hotline:</span><a href="tel:0981744199">0981.744.199</a>
							...
							<div class="social-sharing ">
								...
								<!-- <div class="social-media" data-permalink="https://template-digiworld.bizwebvietnam.net/op-lung-iphone-6-6s-memo-totem">
									...
									<a target="_blank" href="//twitter.com/share?text=ỐplưngiPhone6/6SMemoTotem&amp;url=https://template-digiworld.bizwebvietnam.net/op-lung-iphone-6-6s-memo-totem" class="share-twitter" title="Chia sẻ lên Twitter">
										<i class="fa fa-twitter"></i>
									</a>



									<a target="_blank" href="//pinterest.com/pin/create/button/?url=https://template-digiworld.bizwebvietnam.net/op-lung-iphone-6-6s-memo-totem&amp;media=http://bizweb.dktcdn.net/thumb/1024x1024/100/289/371/products/08-dbdfc9aa-fe11-45bc-ace0-c2c8cb80b32f.jpg?v=1516612166043&amp;description=ỐplưngiPhone6/6SMemoTotem" class="share-pinterest" title="Chia sẻ lên pinterest">
									...
									<a target="_blank" href="//plus.google.com/share?url=https://template-digiworld.bizwebvietnam.net/op-lung-iphone-6-6s-memo-totem" class="share-google" title="+1">
							...
							<div class="thongtinkhuyenmai">
								<div class="content rte rte-summary">
									...
									<ul>
										<li>Giảm giá thêm tới <span style="color:#ff0000;">15%</span> giá phụ kiện, <span style="color:#ff0000;">1%</span> giá máy cho hội viên Smember</li>
										<li>Trả góp lãi suât <span style="color:#ff0000;">0%</span> với thẻ tín dụng ANZ, Sacombank, Nam Á Bank, Shinhanbank</li></ul>
									</div>
								</div>
						...
						<div id="tab-2" class="tab-content">
							<div class="rte">
								<h4>Không cần trực tiếp đến siêu thị mua hàng, bạn có thể lựa chọn cách mua hàng online bằng cách chọn một trong những cách mua hàng sau:</h4>

								<h4>Cách 1: Gọi điện thoại đến tổng đài (028-38.102.102) hoặc (1800.1060) từ 7g30-22g (cả CN & ngày lễ) để đặt hàng, nhân viên chúng tôi luôn sẵn phục vụ, tư vấn và hỗ trợ quý khách mua được sản phẩm ưng ý.</h4>

								<h4>Cách 2: Đặt mua hàng online trên website shopmobie.com:</h4>
								<p>
									<h5>Bước 1: Tìm sản phẩm cần mua</h5><br>
									Bạn có thể truy cập website shopmobie.com để tìm và chọn sản phẩm muốn mua bằng nhiều cách:<br>
									...
									+ Trang web luôn có sẵn những gợi ý sản phẩm hot nhất, có chương trình khuyến mãi hấp dẫn, bạn cũng có thể chọn xem ngay mà không cần tìm kiếm:<br>



									+ Sử dụng menu sản phẩm của website: chọn loại sản phẩm muốn mua là điện thoại <br>
									...
									<h5>Bước 2: Đặt mua sản phẩm</h5><br>
									Sau khi chọn được sản phẩm ưng ý muốn mua, bạn tiến hành đặt hàng bằng cách:

									+ Chọn vào nút MUA NGAY nếu bạn muốn thanh toán luôn toàn bộ giá tiền sản phẩm, chọn vào nút MUA TRẢ GÓP hoặc TRẢ GÓP LÃI SUẤT 0% nếu bạn muốn mua theo hình thức trả góp.<br>
									...
									+ Ngoài ra, nếu quý khách đang sở hữu phiếu mua hàng, mã giảm giá... thì hãy nhập trong bước đặt hàng để được giảm giá theo các bước tại hướng dẫn: Cách sử dụng phiếu mua hàng.<br>

									+ Sau khi đặt hàng thành công, Thế Giới Di Động sẽ liên hệ quý khách để xác nhận và hoàn tất thủ tục.<br>

									Ngoài các cách trên, để mua hàng tại Thế Giới Di Động quý khách còn có thể để lại bình luận tại bất kì đâu trên website (có thông tin tên, số điện thoại...), hoặc trực tiếp chat với tư vấn viên của công ty để được tư vấn và đặt mua sản phẩm.<br>
						...
						<div id="tab-3" class="tab-content">
							<div class="rte">
								<div id="bizweb-product-reviews" class="bizweb-product-reviews" data-id="9721688"><div><div class="title-bl">
					...
					<div class="wrap_module_service">
						...
						<div class="item_service">
							<div class="wrap_item_">
								<div class="content_service">
									<p>Đặt hàng online</p>
									<span class="phone_red">Gọi ngay <a class="hai01" href="tel:0981744199">0981744199</a></span>
								</div>
							</div>
						</div>
					...
					<div class="time_work">
						<ul class="list-menu list-menu-time">
							<li class="li_menu li_menu_xxx">
								<a class="rc yeloww" href="tel:0981744199">0981.744.199</a>
