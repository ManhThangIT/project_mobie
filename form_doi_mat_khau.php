									...
									<form accept-charset="UTF-8" action="./process_login.php" id="customer_login" method="post">
										...
										<div class="fw clearfix form-signup row">
											<fieldset class="form-group fr_gr_pd col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<label>Email:</label>
												<input type="email" class="form-control form-control-lg" name="email" id="customer_email" >

												<label>Mật khẩu:</label>
												<input type="password" class="form-control form-control-lg"  name="mat_khau" id="customer_password" >
												<select name="ghinho">
												...
												<div class="col-sm-6">
													<div class="collapse in" id="collapseExample-11883195" style="display: block;" aria-expanded="true">
														<div id="edit_address_11883195" class="form-list">
															...
															<form action="xl_doi_mat_khau.php">
																
																<div class="clearfix">
																	<fieldset class="form-group">
																		<label>Mật khẩu cũ <span class="required">*</span></label>
																		<input type="text" class="form-control" name="mat_khau_cu">
																	</fieldset>
																	<fieldset class="form-group">
																	...
																	<fieldset class="form-group">
																		...
																		<input type="text" class="form-control" name="mat_khau_moi">
																	</fieldset>

																	<fieldset class="form-group">
																		<label>Nhập lại mật khẩu mới <span class="required">*</span></label>
																		<input type="text" class="form-control" name="re_mat_khau_moi" >
																	</fieldset>
																...
																<div class="form-group clearfix">											
																	<div class="col-sm-9">
																		<div class="row">
																			<button class="btn btn-primary" name="cap_nhap"><span>Cập nhật mật khẩu</span></button>																	
																			<a href="index.php"><button class="btn btn-dark btn-fix-addr" type="button">
																				Hủy
																			</button></a>
																		</div>
																	</div>
						...
						<div id="b" class="col-xs-12 col-sm-12 col-lg-3 col-right-account margin-top-20">
							<div class="block-account">
								...
								<div class="block-content form-signup">
									<p>Tên tài khoản: <strong style="line-height: 20px;"><?php echo $row['ten_khach_hang'] ?></strong></p>
									<p><i class="fa fa-home font-some" aria-hidden="true"></i>  <span>Địa chỉ: <?php echo $row['dia_chi'] ?></span></p>
									<p><i class="fa fa-mobile font-some" aria-hidden="true"></i> <span>Điện thoại: <?php echo $row['sdt'] ?></span> </p>
									<!-- <p><i class="fa fa-map-marker font-some" aria-hidden="true"></i> <span> Địa chỉ 1: Ha Nam</span></p> -->
									...
									<p style="margin-top:20px;"><a href="xem_thong_tin.php" class="btn btn-full btn-primary">Xem thông tin</a></p>
