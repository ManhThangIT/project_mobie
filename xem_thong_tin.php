														...
														<div id="edit_address_11883195" class="form-list">
															...
															<form action="xl_sua_thong_tin.php">
																...
																<div class="form-group clearfix">											
																	<div class="col-sm-9">
																		<div class="row">
																			<button class="btn btn-primary" name="sua_thong_tin"><span>Cập nhật địa chỉ</span></button>																	
						...
						<div id="b" class="col-xs-12 col-sm-12 col-lg-3 col-right-account margin-top-20">
							<div class="block-account">
								...
								<div class="block-content form-signup">
									...
									<p style="margin-top:20px;"><a href="form_doi_mat_khau.php" class="btn btn-full btn-primary">Đổi mật khẩu</a></p>
