            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Thêm Danh Mục </a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card card-plain">
                                <div class="card-content">
                                    ...
                                    <form action="xl_add_danh_muc.php" method="post" enctype="multipart/form-data">
                                        <table border="1" width="100%">
                                            <tr>
                                                ...
                                                <tr>
                                                    <td colspan="2"><button>Thêm danh mục</button></td>
                                                </tr>
                                            </table>
                                        </form>
