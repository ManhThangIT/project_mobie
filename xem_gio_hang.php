		...
		<section class="awe-section-1">	
			...
			<div class="container">
				<div class="row row-noGutter-2">					
					<section class="main_container collection margin-bottom-30 col-lg-12">
						<!-- __________________Tên danh mục_______________ -->
						
						
						<div class="text-sm-left">			
							<h1 class="title-head margin-top-0">GIỎ HÀNG CỦA BẠN</h1>
						</div>
			...
			<!-- <div class="header-cart" style="background:#fff;">
				...
				<div class="title-cart">
					<h3>Giỏ hàng của bạn có <span class="count_cart_h count_item count_item_pr">1</span> sản phẩm <i class="fa fa-caret-right" aria-hidden="true"></i></h3>
				</div>
					...
					<form class="margin-bottom-0">
						<div class="bg-scroll">
							<div class="cart-thead">
								...
								<div style="width: 33%"><span class="nobr">Tên sản phẩm</span>
								</div>
								<div style="width: 15%" class="a-center"><span class="nobr">Đơn giá</span>
								</div>
								<div style="width: 14%" class="a-center">Số lượng</div>

								<div style="width: 15%" class="a-center">Thành tiền</div>

								<div style="width: 6%">Xoá</div></div>
								...
								foreach ($_SESSION['gio_hang'] as $ma_san_pham => $tung_san_pham) { 
									...
									<div class="cart-tbody">
										...
										<div class="item-cart productid-15526574">


											<div style="width: 17%" class="image">
												<a class="product-image" >
													
													<img width="75" height="auto" src="../khachhang/dashboard/san_phamx/<?php echo $tung_san_pham['anh'] ?>">
											...
											<div style="width: 33%" class="a-center prd_name">
												<h2 class="product-name"> 
													<a class="text2line" href="/op-lung-iphone-6-6s-memo-totem"><?php echo $tung_san_pham['ten_san_pham'] ?></a> 
												...
												<div style="width: 14%" class="a-center"><div class="input_qty_pr">
													...
													<div class="input_qty_pr">
														...
														<a href="thay_doi_so_luong_san_pham_trong_gio_hang.php?kieu=tru&ma_san_pham=<?php echo $ma_san_pham ?>">
															<button class="reduced_pop items-count btn-minus" type="button">–</button>
														</a>

														<input type="text" maxlength="12" min="1" class="input-text number-sidebar input_pop input_pop qtyItem15526574" id="qtyItem15526574" name="Lines" size="4" value="<?php echo $tung_san_pham['so_luong']; ?>">
														
														<a href="thay_doi_so_luong_san_pham_trong_gio_hang.php?kieu=cong&ma_san_pham=<?php echo $ma_san_pham; ?>">
												...
												<div style="width: 6%">
													<a class="button remove-item remove-item-cart" title="Xóa" href="xoa_san_pham_trong_gio_hang.php?ma_san_pham=<?php echo $ma_san_pham ?>" data-id="15526574">
														<span><i class="fa fa-times" aria-hidden="true"></i></span></a>
										...
										<div class="cart-collaterals cart_submit row"><div class="totals col-sm-12 col-md-12 col-xs-12"><div class="totals">
												...
												<ul class="checkout">
													<li class="clearfix f-right">
														...
														<a href="xoa_gio_hang.php">
															...
															<button class="btn btn-white f-left" title="Xóa Giỏ Hàng" type="button" onclick="window.location.href='xem_gio_hang.php'">

																<span>Xóa Giỏ Hàng</span></button>
															</a>
															<button class="btn btn-white f-left" title="Tiếp tục mua hàng" type="button" onclick="window.location.href='index.php'">

																<span>Tiếp tục mua hàng</span></button>

																<button class="btn btn-primary button btn-proceed-checkout f-right" title="Thực hiện thanh toán" type="button" onclick="window.location.href='dat_hang.php'"><span>Thực hiện thanh toán</span></button></li></ul>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="widget-ft wg-logo">
											...
											<ul class="contact">
												...
												<li class="sdt">
													...
													<a href="tel:0981744199">0981.744.199</a>
