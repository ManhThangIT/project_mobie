...
<body onselectstart="return false" oncontextmenu="return false">
	...
	<div class="banner_a">
		...
		<div class="banner_ pull-right  banner_fixed_index_2">
												...
												if(!empty($_SESSION['gio_hang'])){
													...
													<div class="top-cart-content">
														...
														<ul id="cart-sidebar" class="mini-products-list count_li">
															...
															foreach ($_SESSION['gio_hang'] as $ma_san_pham => $tung_san_pham) { 
																...
																<ul class="list-item-cart">
																	<li class="item productid-15526574">
																		<div class="border_list">
																			<a class="product-image">	
																				<img width="100" height="auto" src="../khachhang/dashboard/san_phamx/<?php echo $tung_san_pham['anh'] ?>">
																			...
																			<div class="detail-item">
																				...
																				<div class="product-details">
																					...
																					<p class="product-name"> 
																						<a class="text2line"><?php echo $tung_san_pham['ten_san_pham'] ?></a>
																					</p>
																				</div>
														...
														<div class="pd right_ct">
															<a href="dat_hang.php" class="btn btn-primary">
																<span>Tiến hành thanh toán</span>
															</a>
															<a href="./xem_gio_hang.php" class="btn btn-white">
		...
		<div class="home-slider owl-carousel owl-theme not-aweowl">
			...
			<div class="item">
				<a href="#" class="clearfix">
					<img src="https://bizweb.dktcdn.net/100/289/371/themes/634361/assets/slider_1.png?1524126221691" alt="Slider 1">
				</a>	
			</div>
			...
			<div class="item">
				<a href="#" class="clearfix">
					<img src="https://bizweb.dktcdn.net/100/289/371/themes/634361/assets/slider_2.png?1524126221691" alt="Slider 2">
				</a>	
			</div>
	...
	<section class="awe-section-3">	
		<!-- _______________ SẢN PHẨM 1____________	 -->
		<?php include 'include/product_1.php';?>
						...
						<div class="adv_bottom_inner">
							<figure>
								<a href="#" title="Banner quảng cáo">
									<img class="img-responsive" src="https://bizweb.dktcdn.net/100/289/371/themes/634361/assets/banner_qc.png?1524126221691" alt="Banner quảng cáo">
								</a>
							</figure>
	...
	<section class="section_buy_many">
		<!-- _____________SẢN PHẨM MUA NHIỀU____________ -->
		<?php include 'include/product_3.php'; ?>
	</section>
	<section class="section_buy_many">
		<!-- _____________SẢN PHẨM MUA NHIỀU____________ -->
		<?php include 'include/xiaomi.php'; ?>
	</section>
	<section class="section_buy_many">
		<!-- _____________SẢN PHẨM MUA NHIỀU____________ -->
		<?php include 'include/nokia.php'; ?>
	</section>
	<section class="section_buy_many">
		<!-- _____________SẢN PHẨM MUA NHIỀU____________ -->
		<?php include 'include/oppo.php'; ?>
	</section>
	<section class="section_buy_many">
		<!-- _____________SẢN PHẨM MUA NHIỀU____________ -->
		<?php include 'include/samsung.php'; ?>
	</section>
					...
					<div class="wrap_item_srv owl-carousel owl-theme service_content" data-nav="false" data-dot="true" data-lg-items="3" data-md-items="3" data-xs-items="1" data-sm-items="2" data-margin="15">
						<div class="col-item-srv">
							<div class="service_item_ed">
								<span class="iconx">
									<img alt="Giao hàng miễn phí" src="https://bizweb.dktcdn.net/100/289/371/themes/634361/assets/srv_1.png?1524126221691"/>
								</span>
								<div class="content_srv">
									<span class="title_service">Giao hàng miễn phí</span>
									<span class="content_service">Với tất cả đơn hàng nào trên 800.000đ</span>
								</div>
							</div>
						</div>
						<div class="col-item-srv">
							<div class="service_item_ed">
								<span class="iconx">
									<img alt="Digiworld" src="https://bizweb.dktcdn.net/100/289/371/themes/634361/assets/srv_2.png?1524126221691"/>
								</span>
								<div class="content_srv">
									<span class="title_service">Sản phẩm chất lượng</span>
									<span class="content_service">Cam kết 100% hàng nhập khẩu chính hãng</span>
								</div>
							</div>
						</div>
						<div class="col-item-srv">
							<div class="service_item_ed">
								<span class="iconx">
									<img alt="Mua hàng giá ưu đãi" src="https://bizweb.dktcdn.net/100/289/371/themes/634361/assets/srv_3.png?1524126221691"/>
								</span>
								<div class="content_srv">
...
<!-- _____________CODE CHỐNG F12___________ -->
...
<script type="text/javascript">
	// ___________ ấn dc chuột phải__________
// 	$(document).on("contextmenu", function (e) {        
//     e.preventDefault();
// });
</script>
<!-- _________________BLOCK CRTL + U__________ -->
<script>
    /*function check(e)
    {
    alert(e.keyCode);
