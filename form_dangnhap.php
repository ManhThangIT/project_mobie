										...
										<form accept-charset="UTF-8" action="./process_login.php" id="customer_login" method="post">
											...
											<div class="form-signup clearfix">
												...
												<div class="pull-xs-left" style="margin-top: 25px;">
													<button class="btn btn-style btn-primary" name="dangnhap">Đăng nhập</button>

													<a href="form_dangky.php" class="btn-link-style btn-register" style="margin-left: 20px;text-decoration: underline; ">Đăng ký</a>
												</div>
											</div>
										</form>
									</div>
