            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Danh Sách Nhà Sản Xuất </a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card card-plain">
                                <div class="card-content">
                                    ...
                                    ?>
                                    <form action="xl_sua_thong_tin.php" method="POST" enctype="multipart/form-data">
                                        <table border="1" width="100%">
                                            <tr>
                                                <td><input type="hidden" name="ma_admin" value="<?php echo $ma_admin; ?>"></td>
                                            </tr>
                                            <tr>
                                                <th>Tên Admin</th>
                                                <td><input type="text" name="ten_admin" value="<?php echo $rs['ten_admin']; ?>"></td>
                                            </tr>
                                            <tr>
                                                <th>Số điện thoại</th>
                                                <td><input type="number" name="sdt" value="<?php echo $rs['sdt']; ?>"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <th>Địa chỉ</th>
                                                <td><input type="text" name="dia_chi" value="<?php echo $rs['dia_chi']; ?>"></td>
                                            </tr>
                                            <tr>
                                                <th>Giới tính</th>
                                                <td><input type="number" name="gioi_tinh" value="<?php echo $rs['gioi_tinh']; ?>"></td>
                                            </tr>
