                        ...
                        <div class="col-md-12">
                            <div class="card card-plain">
                                <div class="card-content">
                                    ...
                                    <form action="xl_them_admin.php" method="post" enctype="multipart/form-data">
                                        <table border="1" width="100%">
                                            ...
                                            <tr>
                                                <th>Mật khẩu</th>
                                                <td><input type="number" name="mat_khau"></td>
                                            </tr>
                                            <tr>
                                                <th>Địa chỉ</th>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                <th>Cấp độ</th>
                                                <td><input type="text" name="cap_do"></td>
                                            </tr>
                                            
                                            <tr>
                                                <td colspan="2"><button>Thêm Admin</button></td>
                                            </tr>
                                        </table>
                                    </form>
