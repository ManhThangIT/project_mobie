                                ...
                                <div class="card-content">
                                    ...
                                    <form action="xl_sua_danh_muc.php" method="POST" enctype="multipart/form-data">
                                        <table border="1" width="100%">
                                            <tr>
                                                <td><input type="hidden" name="ma_danh_muc" value="<?php echo $ma_danh_muc; ?>"></td>
                                            </tr>
                                            <tr>
                                                <th>Tên Danh Mục</th>
                                                <td><input type="text" name="ten_danh_muc" value="<?php echo $rs['ten_danh_muc']; ?>"></td>
                                            </tr>

                                            <tr>
                                                <td colspan="2"><button>Sửa danh mục</button></td>
                                            </tr>
                                        </table>    
                                    </form>
