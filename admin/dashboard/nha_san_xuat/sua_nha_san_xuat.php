            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> SỬA NHÀ SẢN XUẤT </a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">SỬA NHÀ SẢN XUẤT</h4>
                                    <?php 
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th>
                                                        <a href="">
                                                            <button>Sửa Nhà Sản Xuất</button>
                                                        </a>
                                                    </th>
                                                </tr>
                                            </tfoot>
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><input type="hidden" name="ma_nha_san_xuat" value="<?php echo $ma_nha_san_xuat; ?>">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="ten_nha_san_xuat" value="<?php echo $rs['ten_nha_san_xuat']; ?>">
                                                    </td>
                                                </tr>
                                            </tbody>
