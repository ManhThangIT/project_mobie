            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> XEM NHÀ SẢN XUẤT </a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">XEM NHÀ SẢN XUẤT</h4>
                                    <?php
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo "Có $count nhà sản xuất"?></th>
                                                    </tr>
                                                    <tr>
                                                        <th style="font-size: 15px;">Mã Sản Xuất</th>
                                                        <th style="font-size: 15px;">Tên Nhà Sản Xuất</th>
                                            ...
                                            <tbody>
                                                ...
                                                while($row = mysqli_fetch_array($result)){
                                                    ?>
                                                    <tr>
                                                        <td style="padding: 0px; width: 10px;"><?php echo $row['ma_nha_san_xuat'];?></td>
                                                        <td><?php echo $row['ten_nha_san_xuat'];?></td>
                                                        <td class="text-right">
                                                            <a href="them_nha_san_xuat.php" class="btn btn-simple btn-info btn-icon like" style="padding: 0;margin: 5;">
                                                                <i class="material-icons">add_box</i>
                                                            </a>
                                                            <a href="sua_nha_san_xuat.php?ma_nha_san_xuat=<?php echo $row['ma_nha_san_xuat']?>" class="btn btn-simple btn-warning btn-icon edit" style="padding: 0;margin: 5;">
