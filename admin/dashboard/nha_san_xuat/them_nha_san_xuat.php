            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> THÊM NHÀ SẢN XUẤT </a>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="material-datatables">
                                        <form action="xl_them_nha_san_xuat.php" method="post" enctype="multipart/form-data">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="hidden" name="ma_nha_san_xuat" value="<?php echo $ma_nha_san_xuat; ?>">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="ten_nha_san_xuat">
                                                    </td>
                                                </tr>
                                            </tbody>
