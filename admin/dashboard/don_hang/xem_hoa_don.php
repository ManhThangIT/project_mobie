                                                ...
                                                <tbody>
                                                    <?php 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right">
                                                                <a href="thay_doi_tinh_trang_don_hang.php?ma_hoa_don=<?php echo $ma_hoa_don ?>&kieu=duyet" class="btn btn-simple btn-info btn-icon like" style="padding: 0;margin: 5;">
                                                                    <i class="material-icons">check</i>
                                                                </a>

                                                                <a href="thay_doi_tinh_trang_don_hang.php?ma_hoa_don=<?php echo $ma_hoa_don ?>&kieu=huy" class="btn btn-simple btn-danger btn-icon remove" style="padding: 0;margin: 5;">
