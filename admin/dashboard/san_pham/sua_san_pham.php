                                    ...
                                    <div class="material-datatables">
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><input type="hidden" name="ma_san_pham" value="<?php echo $ma_san_pham; ?>">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="ten_san_pham" value="<?php echo $rs['ten_san_pham']; ?>">
                                                    </td>
                                                    <td>
                                                        <textarea name="thong_so_ki_thuat">
                                                            <?php echo $rs['thong_so_ki_thuat']; ?>
                                                        </textarea>
                                                    </td>
                                                    <td>
                                                        <input type="number" name="gia" value="<?php echo $rs['gia']; ?>">
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <thead>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" name="so_luong_da_nhap" value="<?php echo $rs['so_luong_da_nhap']; ?>">
                                                </td>
                                               
                                                <?php 

                                                include '../connect_database.php';
                                                $querya = "select * from nha_san_xuat";
