                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    $query_count = "select count(*) from danh_muc
                                    where ten_danh_muc like '%$tim_kiem%'";
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                while($row = mysqli_fetch_array($result)){
                                                    ?>
                                                    <tr>
                                                        <td style="padding: 0px; width: 10px;"><?php echo $row['ma_danh_muc'];?></td>

                                                        <td><?php echo $row['ten_danh_muc'];?></td>
                                                        <td class="text-right">
                                                            <a href="them_danh_muc.php" class="btn btn-simple btn-info btn-icon like" style="padding: 0;margin: 5;">
                                                                <i class="material-icons">add_box</i>
                                                            </a>
                                                            <a href="sua_danh_muc.php?ma_danh_muc=<?php echo $row['ma_danh_muc']?>" class="btn btn-simple btn-warning btn-icon edit" style="padding: 0;margin: 5;">
