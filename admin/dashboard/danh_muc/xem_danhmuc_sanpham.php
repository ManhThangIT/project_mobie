            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> DANH SÁCH DANH MỤC SẢN PHẨM </a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    join danh_muc
                                    on danhmuc_sanpham.ma_danh_muc = danh_muc.ma_danh_muc
                                    join san_pham
                                    on danhmuc_sanpham.ma_san_pham = san_pham.ma_san_pham
                                    where ten_danh_muc like '%$tim_kiem%' 
                                    ...
                                    $query_count = "SELECT count(*) from danhmuc_sanpham
                                    join danh_muc
                                    on danhmuc_sanpham.ma_danh_muc = danh_muc.ma_danh_muc
                                    join san_pham
                                    on danhmuc_sanpham.ma_san_pham = san_pham.ma_san_pham
                                    where ten_danh_muc like '%$tim_kiem%' 
                                    and ten_san_pham like '%$tim_kiem%'";
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo "Có $count danh mục"?></th>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <tbody>
                                                ...
                                                while($row = mysqli_fetch_array($result)){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <a href="them_danhmuc_sanpham.php" class="btn btn-simple btn-info btn-icon like" style="padding: 0;margin: 5;">
                                                                <i class="material-icons">add_box</i>
                                                            </a>
                                                            <a href="them_danhmuc_sanpham.php?ma_danh_muc=<?php echo $row['ma_danh_muc']?>" class="btn btn-simple btn-warning btn-icon edit" style="padding: 0;margin: 5;">
                                                                <i class="material-icons">edit</i>
                                                            </a>
                                                            <a href="xoa_danhmuc_sanpham.php?ma_san_pham=<?php echo $row['ma_san_pham']?>" class="btn btn-simple btn-danger btn-icon remove" style="padding: 0;margin: 5;">
