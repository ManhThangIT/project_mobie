            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> THÊM DANH MỤC SẢN PHẨM </a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    $query_dm = "SELECT * from danh_muc";
                                    $result_dm = mysqli_query($connect,$query_dm);
                                    ?>
                                    
                                    <div class="material-datatables">
                                        <form action="xl_them_danhmuc_sanpham.php" method="post" enctype="multipart/form-data">
                                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <th>
                                                            <a href="">
                                                                <button>T/S Danh Mục Sản Phẩm</button>
                                                            </a>
                                                        </th>
                                                    </tr>
                                                </tfoot>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <select name="ma_san_pham" style="width: 202px;height: 32px">
                                                                <?php 
                                                                while ($row_sp = mysqli_fetch_array($result_sp)) {
                                                                    ?>
                                                                    <option value="<?php echo $row_sp['ma_san_pham'] ?>">
                                                                        <?php echo $row_sp['ten_san_pham'] ?>
                                                                    </option>
                                                                    <?php 
                                                                }
                                                                ?>
                                                        ...
                                                        <td>
                                                            <select name="ma_danh_muc" style="width: 202px;height: 32px">
                                                                <?php 
                                                                while ($row_dm = mysqli_fetch_array($result_dm)) {
                                                                    ?>
                                                                    <option value="<?php echo $row_dm['ma_danh_muc'] ?>">
