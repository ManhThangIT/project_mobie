            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> SỬA ADMIN </a>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="material-datatables">
                                        <form action="xl_sua_admin.php" method="post" enctype="multipart/form-data">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="font-size: 15px;">Mật Khẩu</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><input type="hidden" name="ma_admin" value="<?php echo $ma_admin; ?>">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="ten_admin" value="<?php echo $rs['ten_admin']; ?>">
                                                    </td>
                                                   
                                                    <td>
                                                        <input type="number" name="sdt" value="<?php echo $rs['sdt']; ?>">
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input type="text" name="mat_khau" value="<?php echo $rs['mat_khau']; ?>">
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <thead>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" name="gioi_tinh" value="<?php echo $rs['gioi_tinh']; ?>">
                                                </td>
                                                <td>
                                                    <input type="number" name="cap_do" value="<?php echo $rs['cap_do']; ?>">
                                                </td>
