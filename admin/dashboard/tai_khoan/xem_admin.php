            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> XEM ADMIN </a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">XEM ADMIN</h4>
                                    <?php
                                            ...
                                            <tbody>
                                                ...
                                                while($row = mysqli_fetch_array($result)){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if($_SESSION['cap_do']==2){?>
                                                        <td class="text-right">
                                                            <a href="them_admin.php" class="btn btn-simple btn-info btn-icon like" style="padding: 0;margin: 5;">
                                                                <i class="material-icons">add_box</i>
                                                            </a>
                                                            <a href="sua_admin.php?ma_admin=<?php echo $row['ma_admin']?>" class="btn btn-simple btn-warning btn-icon edit" style="padding: 0;margin: 5;">
